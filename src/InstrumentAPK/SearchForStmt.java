...
//        Settings.initialiseSoot();      //check with settings
...
//        Scene.v().setSootClassPath("classes:/home/dhruv2601/IdeaProjects/Soot_Instrumenter/InstrumentAPK/libs/rt.jar:/home/dhruv2601/IdeaProjects/Soot_Instrumenter/InstrumentAPK/libs/jce.jar");
        ...
        PackManager.v().getPack("jtp").add(new Transform("jtp.myInstrumenter", new BodyTransformer() {
			...
			protected void internalTransform(final Body b, String phaseName, @SuppressWarnings("rawtypes") Map options) {
				...
				System.out.println("internalTransform is here!!");
                locationRequest.add(String.valueOf("HEHEHEHEHAHAHA"));
...
//                Constants.ANDROID_JAR + "android-25/android.jar"
        ...
        {
            System.out.println("Excepptionnn: "+e.getMessage());
        }
		/* 
